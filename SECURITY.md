...
Supported installable release: `0.1.x`. Public `main` also carries v0.2.12 development source, but no v0.2.x APK is a supported release. Verify a plugin build's source commit, target ATAK build, signer fingerprint, and SHA-256 before installation.
